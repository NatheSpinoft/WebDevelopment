...
class ReceiptApp:
    def __init__(self, root):
        ...
        show_total_btn = tk.Button(self.right_frame, text="Show Total", command=self.calculate_total)
        show_total_btn.grid(row=1, column=0, columnspan=2)
    ...
    def add_row(self):
        ...
        # Bind the item selection to update price
